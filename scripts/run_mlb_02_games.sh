#!/usr/bin/env bash
# Stage 02 -- MLB feed/live capture (ONLINE, resumable)
#
#   ./scripts/run_mlb_02_games.sh --season 2026
#   ./scripts/run_mlb_02_games.sh --season 2026 --max-games 500
#
...
run_stage "mlb_02_games" python/mlb_02_games_scrape.py "$@"
